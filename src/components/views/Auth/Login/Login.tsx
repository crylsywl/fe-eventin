...
const Login = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center justify-center gap-10 lg:flex-row lg:gap-20">
      ...
      >
        <ModalContent>
          <ModalHeader>Login Feature Under Maintenance</ModalHeader>
          <ModalBody>
            We apologize for the inconvenience, but the login feature is
            currently undergoing scheduled maintenance to improve our service.
            We expect to be back online shortly. Please try again in a few
